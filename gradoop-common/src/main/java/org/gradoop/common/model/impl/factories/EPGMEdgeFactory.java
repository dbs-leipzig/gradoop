 ...
 */
package org.gradoop.common.model.impl.factories;
...
public class EPGMEdgeFactory implements EdgeFactory<EPGMEdge>, Serializable {
  ...
  @Override
  public EPGMEdge createEdge(GradoopId sourceVertexId,
    GradoopId targetVertexId) {
    return initEdge(GradoopId.get(), sourceVertexId, targetVertexId);
  }

  @Override
  public EPGMEdge initEdge(final GradoopId id, final GradoopId sourceVertexId,
  ...
  @Override
  public EPGMEdge createEdge(String label, GradoopId sourceVertexId,
    GradoopId targetVertexId) {
    return initEdge(GradoopId.get(), label, sourceVertexId, targetVertexId);
  }

  @Override
  public EPGMEdge initEdge(final GradoopId id, final String label,
  ...
  public EPGMEdge initEdge(final GradoopId id, final String label,
    ...
    return new EPGMEdge(id, label, sourceVertexId, targetVertexId,
      properties, graphIds);
  }
