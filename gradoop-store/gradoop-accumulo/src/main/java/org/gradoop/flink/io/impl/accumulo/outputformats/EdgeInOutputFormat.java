 ...
 */
public class EdgeInOutputFormat extends BaseOutputFormat<Edge> {
  ...
  /**
   * Create a new output format for gradoop edge-in
   *
   * @param properties accumulo properties
   */
  public EdgeInOutputFormat(Properties properties) {
    super(properties);
  }
  ...
  protected Mutation writeMutation(Edge record) {
    ...
    mutation = handler.writeLink(mutation, record, true);
    return mutation;
  }
