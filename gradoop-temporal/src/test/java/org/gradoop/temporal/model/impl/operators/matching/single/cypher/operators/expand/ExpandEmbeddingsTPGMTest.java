...
public class ExpandEmbeddingsTPGMTest extends PhysicalTPGMOperatorTest {
    ...
    ExpansionCriteria noCriteria = new ExpansionCriteria(null, null, null, null, null,
            null, null, null, null, null);
    // tx_to of vertices must be ascending
    ExpansionCriteria withCriteria = new ExpansionCriteria(null, x->x.f1>=x.f0, null, null,
    ...
    public void testLowerBound0() throws Exception {
        ...
        assertEmbeddingTPGMExists(result, (embedding) ->
                ...
                && Arrays.equals(embedding.getTimes(1), aTime)
        );
