...
public class FilterTemporalEmbeddingsNodeTest {
  ...
  public void testExecute() throws Exception {
    ...
    List<EmbeddingTPGM> result =
      new FilterTemporalEmbeddingsNode(mockChild, filterPredicate).execute().collect();
    ...
    assertEquals(new FilterTemporalEmbeddingsNode(mockChild, filterPredicate).getEmbeddingMetaData(),
      metaData);
  }
}
