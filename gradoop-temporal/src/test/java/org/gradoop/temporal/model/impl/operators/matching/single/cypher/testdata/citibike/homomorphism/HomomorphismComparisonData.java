...
public class HomomorphismComparisonData implements TemporalTestData {
  ...
  public Collection<String[]> getData() {
    ...
    data.add(new String[] {
      ...
      CBCypherTemporalPatternMatchingTest.defaultData,
      CBCypherTemporalPatternMatchingTest.prepareQueryString(
        "MATCH (a) WHERE a.tx_to >= Timestamp(2013-07-28T00:59:59)"
      ),
      "expected1,expected2",
    ...
    data.add(new String[] {
      ...
      CBCypherTemporalPatternMatchingTest.prepareQueryString(
        "MATCH (a)-[e]->(b) WHERE Timestamp(2013-06-01T00:01:00) >= e.tx_from " +
          "AND NOT Timestamp(2013-06-01T00:30:00)> tx_to"),
      "expected1",
      "expected1[(s2)-[e2]->(s2)]"
    });
    ...
    data.add(new String[] {
      ...
      CBCypherTemporalPatternMatchingTest.defaultData,
      CBCypherTemporalPatternMatchingTest.prepareQueryString(
        "MATCH (a) WHERE a.tx_to < Timestamp(2013-07-11)"
      ),
      "expected1,expected2,expected3",
    ...
    data.add(new String[] {
      ...
      CBCypherTemporalPatternMatchingTest.prepareQueryString(
        "MATCH (a)-[e]->(b) WHERE e.tx_from <= Timestamp(2013-06-01T00:01:00)" +
          " AND Timestamp(2013-05-12) < a.val_from " +
    ...
    data.add(new String[] {
      ...
      CBCypherTemporalPatternMatchingTest.defaultData,
      CBCypherTemporalPatternMatchingTest.prepareQueryString(
        "MATCH (a) WHERE a.tx_to < Timestamp(2013-07-11) AND" +
