...
public class ExpansionCriteriaTest {
  ...
  public void testCheckSingleCriterionOnExpansion() {
    ...
    TemporalEdgeWithTiePoint t1 =
      createExpansionEdge(new Long[] {10L, 100L, 10L, 50L}, new Long[] {10L, 120L, 5L, 45L});
    assertTrue(txFromVertex.checkExpansion(embedding, t1));
    // does not fulfill the condition
    TemporalEdgeWithTiePoint t2 =
      createExpansionEdge(new Long[] {10L, 100L, 10L, 50L}, new Long[] {0L, 120L, 5L, 45L});
    ...
    ExpansionCriteria valFromVertex = new ExpansionCriteria(null, null, x -> x.f0.equals(x.f1), null, null,
      null, null, null, null, null);
    // fulfills the condition:
    ...
    ExpansionCriteria txToEdge = new ExpansionCriteria(null, null,
      null, null, null, x -> x.f1 >= x.f0 && x.f1 - x.f0 <= 20, null, null, null, null);
    // fulfills the condition:
    ...
    ExpansionCriteria valToEdge = new ExpansionCriteria(null, null,
      null, null, null,
      null, null, x -> !x.f0.equals(x.f1), null, null);
    // fulfills the condition:
