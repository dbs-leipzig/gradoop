...
//------------------------------------------------------------------------------------------------
  ...
  private static final GradoopId vertex0 = GradoopId.get();
  private static final GradoopId vertex1 = GradoopId.get();
  private static final GradoopId edge0 = GradoopId.get();
  private static final GradoopId edge1 = GradoopId.get();
  private static final GradoopId edge2 = GradoopId.get();
  private static final GradoopId edge3 = GradoopId.get();
  ...
  public void testVertexHomomorphismEdgeHomomorphism() throws Exception {
    ...
    testMorphisms(emptyList, emptyList, // vertex columns
      ...
      Lists.newArrayList(createEmbeddingTPGM(vertex0, edge0, vertex1, edge0),
        createEmbeddingTPGM(vertex0, edge0, vertex1, edge1),
        createEmbeddingTPGM(vertex0, edge1, vertex1, edge0),
        createEmbeddingTPGM(vertex0, edge1, vertex1, edge1),
        createEmbeddingTPGM(vertex0, edge2, vertex0, edge2),
        createEmbeddingTPGM(vertex0, edge2, vertex0, edge3),
        createEmbeddingTPGM(vertex0, edge3, vertex0, edge2),
        createEmbeddingTPGM(vertex0, edge3, vertex0, edge3)));
  }
  ...
  public void testVertexHomomorphismEdgeIsomorphism() throws Exception {
    ...
    testMorphisms(emptyList, emptyList, // vertex columns
      ...
      Lists.newArrayList(createEmbeddingTPGM(vertex0, edge0, vertex1, edge1),
        createEmbeddingTPGM(vertex0, edge1, vertex1, edge0),
        createEmbeddingTPGM(vertex0, edge2, vertex0, edge3),
        createEmbeddingTPGM(vertex0, edge3, vertex0, edge2)));
  }
   ...
   */
  private void testMorphisms(List<Integer> distinctVertexColumnsLeft,
                             List<Integer> distinctVertexColumnsRight,
                             List<Integer> distinctEdgeColumnsLeft, List<Integer> distinctEdgeColumnsRight,
                             List<EmbeddingTPGM> expectedEmbeddingTPGM) throws Exception {
    ...
    // merge operator
    MergeTemporalEmbeddings op =
      new MergeTemporalEmbeddings(3, Arrays.asList(0, 2), distinctVertexColumnsLeft,
