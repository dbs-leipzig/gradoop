...
public class TemporalParquetTest extends TemporalGradoopTestBase {
  ...
  public void testWriteTo() throws Exception {
    ...
    testGraph.writeTo(new TemporalParquetDataSink(tempFolderPath, getConfig()));
    getExecutionEnvironment().execute();

    TemporalDataSource dataSource = new TemporalParquetDataSource(tempFolderPath, getConfig());
  ...
  public void testWriteToOverwrite() throws Exception {
    ...
    testGraph.writeTo(new TemporalParquetDataSink(tempFolderPath, getConfig()), true);
    getExecutionEnvironment().execute();
