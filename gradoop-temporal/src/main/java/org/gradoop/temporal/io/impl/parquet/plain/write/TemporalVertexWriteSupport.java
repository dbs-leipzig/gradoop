 ...
 */
public class TemporalVertexWriteSupport extends GradoopWriteSupport<TemporalVertex> {
  @Override
  public MessageType getMessageType() {
    return new GradoopParquetTypeBuilder()
      ...
      .build("temporal_vertex");
  }

  @Override
  public void writeRecord(TemporalVertex record) {
    ...
    writeTimeIntervalField("transaction_time", 4, record.getTransactionTime());
    writeTimeIntervalField("valid_time", 5, record.getValidTime());
  }
}
