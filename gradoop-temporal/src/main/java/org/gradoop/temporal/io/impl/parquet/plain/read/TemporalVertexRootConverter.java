 ...
 */
public class TemporalVertexRootConverter extends GradoopRootConverter<TemporalVertex> {
   ...
   */
  public TemporalVertexRootConverter(MessageType requestedSchema) {
  ...
  @Override
  protected TemporalVertex createRecord() {
