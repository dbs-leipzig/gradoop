...
/**
 * Creates a protobuf {@link TPGMProto.TemporalGraphHead.Builder} from a {@link TemporalGraphHead}
 */
public class TemporalGraphHeadToProtobufObject extends
  ElementToProtobufObject<TemporalGraphHead, TPGMProto.TemporalGraphHead.Builder> {

  @Override
  protected TPGMProto.TemporalGraphHead.Builder newBuilder() {
    return TPGMProto.TemporalGraphHead.newBuilder();
  }

  @Override
  public TPGMProto.TemporalGraphHead.Builder map(TemporalGraphHead value) throws Exception {
