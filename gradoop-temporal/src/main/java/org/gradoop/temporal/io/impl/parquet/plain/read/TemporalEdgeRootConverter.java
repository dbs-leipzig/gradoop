 ...
 */
public class TemporalEdgeRootConverter extends GradoopRootConverter<TemporalEdge> {
   ...
   */
  public TemporalEdgeRootConverter(MessageType requestedSchema) {
  ...
  @Override
  protected TemporalEdge createRecord() {
