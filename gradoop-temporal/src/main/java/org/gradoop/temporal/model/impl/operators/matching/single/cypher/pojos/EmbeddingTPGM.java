 ...
 */
public class EmbeddingTPGM
  extends org.gradoop.flink.model.impl.operators.matching.single.cypher.pojos.Embedding {
  ...
  public void setTimeData(byte[] timeData) {
    // no check for correctness here, for the sake of efficiency...
    this.timeData = timeData.clone();
  }
  ...
  public void copyTo(Embedding target) {
    if (target instanceof EmbeddingTPGM) {
      ...
      ((EmbeddingTPGM) target).setTimeData(newTimes);
    } else {
      super.copyTo(target);
    }
  }
