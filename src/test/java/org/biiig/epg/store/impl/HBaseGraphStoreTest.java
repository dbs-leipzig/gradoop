...
public class HBaseGraphStoreTest {
    ...
    private Iterable<Vertex> createVertices() {
        ...
        vertices.add(new SimpleVertex(vertexID, vertexLabels, vertexProperties, outEdges, inEdges));
    ...
    public void simpleTest() {
        ...
        GraphStore graphStore = HBaseGraphStoreFactory.createGraphStore(config);
        ...
        // re-open
        graphStore.close();
        graphStore = HBaseGraphStoreFactory.createGraphStore(config);
