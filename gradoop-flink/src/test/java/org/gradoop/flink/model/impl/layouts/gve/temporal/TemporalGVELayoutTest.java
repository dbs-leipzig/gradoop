 ...
 */
public class TemporalGVELayoutTest extends GradoopFlinkTestBase {
   ...
   */
  private TemporalGVELayout from(Collection<TemporalGraphHead> graphHeads, Collection<TemporalVertex> vertices,
