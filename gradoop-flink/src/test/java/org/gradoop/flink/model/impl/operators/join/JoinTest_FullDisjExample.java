 ...
 */
public class JoinTest_FullDisjExample extends GradoopFlinkTestBase {
  ...
  public void full_disjunctive_example() throws Exception {
    ...
    GraphThetaJoinWithJoins f = new GraphThetaJoinWithJoins(GRAPH_OUTER_JOIN, DISJUNCTIVE_SEMANTICS,
