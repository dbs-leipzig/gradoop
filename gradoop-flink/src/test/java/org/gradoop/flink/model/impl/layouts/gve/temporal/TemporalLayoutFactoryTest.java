...
/**
 * Test of {@link TemporalLayoutFactory}
 */
public class TemporalLayoutFactoryTest extends GradoopFlinkTestBase {
  ...
  private TemporalLayoutFactory factory;
  ...
  public void setUp() throws Exception {
    ...
    factory = new TemporalLayoutFactory();
    factory.setGradoopFlinkConfig(getConfig());
  }

  /**
   * Test the {@link TemporalLayoutFactory#fromDataSets(DataSet, DataSet)} method.
   *
  ...
  public void testFromDataSets() throws Exception {
    ...
    TemporalGVELayout layout = factory.fromDataSets(vertexDataSet, edgeDataSet);
  ...
  /**
   * Test the {@link TemporalLayoutFactory#fromDataSets(DataSet, DataSet, DataSet)} method.
   *
   * @throws Exception if the test fails
   */
  @Test
  public void testFromDataSetsWithGraphHeads() throws Exception {
    TemporalGVELayout layout = factory.fromDataSets(graphHeadDataSet, vertexDataSet, edgeDataSet);
  ...
  /**
   * Test the {@link TemporalLayoutFactory#fromNonTemporalDataSets(DataSet, DataSet, DataSet)}
   * method.
   *
   * @throws Exception if the test fails
   */
