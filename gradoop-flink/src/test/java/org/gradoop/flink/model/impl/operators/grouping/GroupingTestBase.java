...
public abstract class GroupingTestBase extends GradoopFlinkTestBase {
  ...
  public void testSum() throws Exception {
    ...
    LogicalGraph output =
      new GroupingBuilder()
        .useVertexLabel(true)
        .addVertexAggregator(new SumVertexProperty("a"))
        .addEdgeAggregator(new SumEdgeProperty("b"))
        .setStrategy(getStrategy())
        .build()
        .execute(input);
  ...
  public void testMin() throws Exception {
    ...
    LogicalGraph output =
      new GroupingBuilder()
        .useVertexLabel(true)
        .addVertexAggregator(new MinVertexProperty("a"))
        .addEdgeAggregator(new MinEdgeProperty("b"))
        .setStrategy(getStrategy())
        .build()
        .execute(input);
  ...
  public void testMax() throws Exception {
    ...
    LogicalGraph output =
      new GroupingBuilder()
        .useVertexLabel(true)
        .addVertexAggregator(new MaxVertexProperty("a"))
        .addEdgeAggregator(new MaxEdgeProperty("b"))
        .setStrategy(getStrategy())
        .build()
        .execute(input);
  ...
  public void testVertexLabelSpecificGlobalAggregator() throws Exception {
    ...
    LogicalGraph output = new Grouping.GroupingBuilder()
      .useVertexLabel(true)
      .addGlobalVertexAggregator(new VertexCount())
      .addVertexGroupingKey("topic")
      .addVertexLabelGroup("User", Lists.newArrayList("gender"))
      .setStrategy(getStrategy())
      .build()
  ...
  public void testEdgeLabelSpecificAggregators() throws Exception {
    ...
    LogicalGraph output = new Grouping.GroupingBuilder()
      ...
      .useEdgeLabel(true)
      .addEdgeGroupingKey("until")
      .addEdgeAggregator(new MinEdgeProperty("until"))
      .addEdgeLabelGroup("knows", Lists.newArrayList("since"),
  ...
  public void testEdgeLabelSpecificGlobalAggregators() throws Exception {
    ...
    LogicalGraph output = new Grouping.GroupingBuilder()
      .addGlobalEdgeAggregator(new EdgeCount())
      .useVertexLabel(true)
      .useEdgeLabel(true)
      .addEdgeGroupingKey("until")
      .addEdgeAggregator(new MinEdgeProperty("until"))
