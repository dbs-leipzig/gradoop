...
import static org.gradoop.flink.model.impl.operators.groupingng.GroupingKeys.label;
import static org.gradoop.flink.model.impl.operators.groupingng.GroupingKeys.property;
...
public class LabelSpecificKeyFunctionTest extends GradoopFlinkTestBase {
   ...
   */
  protected LabelSpecificKeyFunction<EPGMVertex> testFunction;
  ...
  public void setUp() {
    ...
    labelToKeys.put("c", Arrays.asList(property("forC")));
