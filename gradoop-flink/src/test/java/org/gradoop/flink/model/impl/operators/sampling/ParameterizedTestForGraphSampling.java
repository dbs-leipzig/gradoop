...
public abstract class ParameterizedTestForGraphSampling extends GradoopFlinkTestBase {
  ...
  int maxIteration = 20;
  /**
   * Number of start vertices used by RandomWalkSampling
   */
  int numberOfStartVertices = 5;
  /**
   ...
   */
  ParameterizedTestForGraphSampling(String testName, long seed, float sampleSize) {
   ...
   */
  public abstract SamplingAlgorithm<EPGMGraphHead, EPGMVertex, EPGMEdge, LogicalGraph, GraphCollection>
  getSamplingOperator();
