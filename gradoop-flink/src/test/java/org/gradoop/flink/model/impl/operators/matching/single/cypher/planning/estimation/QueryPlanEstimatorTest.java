...
import org.gradoop.flink.model.impl.operators.matching.single.cypher.planning.queryplan.binary
  .ExpandEmbeddingsNode;
...
public class QueryPlanEstimatorTest extends EstimatorTestBase  {
  ...
  public void testLabelFree() throws Exception {
    ...
    QueryPlanEstimator estimator = new QueryPlanEstimator(new QueryPlan(nemJoin), queryHandler, STATS);
