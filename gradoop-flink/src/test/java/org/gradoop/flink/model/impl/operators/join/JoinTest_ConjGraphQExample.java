 ...
 */
public class JoinTest_ConjGraphQExample extends GradoopFlinkTestBase {

  private static JoinType GRAPH_INNER_JOIN = JoinType.INNER;
  private static final PredefinedEdgeSemantics CONJUNCTIVE_BASICS
    = PredefinedEdgeSemantics.CONJUNCTIVE;
  ...
  private static final String joinedConjunctively = "result:RGCG{}[" +
   ...
   */
  @Test
  public void paper_conjunctive_example() throws Exception {
