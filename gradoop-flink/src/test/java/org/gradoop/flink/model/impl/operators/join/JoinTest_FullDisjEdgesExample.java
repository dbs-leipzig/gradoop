 ...
 */
public class JoinTest_FullDisjEdgesExample extends GradoopFlinkTestBase {

  private static JoinType GRAPH_OUTER_JOIN = JoinType.FULL_OUTER;
  ...
  public DataSet<Edge> getedgeWithProperties(LogicalGraph left, LogicalGraph right) {
    return left.getVertices()
      ...
      .with(new FlatJoinFunction<Vertex, Vertex, Edge>() {
        @Override
        public void join(Vertex first, Vertex second, Collector<Edge> out) throws Exception {
