...
public class ProtobufParquetTest extends GradoopFlinkTestBase {

  @Rule
  public TemporaryFolder temporaryFolder = new TemporaryFolder();

  @Test
  public void testProtobufParquet() throws Exception {
    try {
      ...
      DataSink dataSink = new ParquetProtobufDataSink(tmpPath, getConfig());
      dataSink.write(input, false);

      executionEnvironment.execute();

      DataSource dataSource = new ParquetProtobufDataSource(tmpPath, getConfig());
