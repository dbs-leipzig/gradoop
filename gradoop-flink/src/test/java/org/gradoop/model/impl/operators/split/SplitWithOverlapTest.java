...
public class SplitWithOverlapTest extends GradoopFlinkTestBase {
  ...
  public void splitOverlapTest() throws Exception {
    ...
    GraphCollection<GraphHeadPojo, VertexPojo, EdgePojo> result =
      input.callForCollection(new SplitWithOverlap<GraphHeadPojo,
  ...
  public static class TestHelperFunction implements UnaryFunction<VertexPojo,
    List<PropertyValue>>{
    @Override
