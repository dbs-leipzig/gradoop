...
/**
 * Computes {@link DistinctVertexPropertiesByLabel} for a given logical graph.
 */
public class DistinctVertexPropertiesByLabelCalculator {

  /**
   * Calculates the statistic for distinct vertex properties by label.
