 ...
 */
public class CollectEdges extends RichGroupReduceFunction<Quad, Tuple2<GradoopId, GradoopId>> {

  private final Tuple2<GradoopId,GradoopId> reusable;
  private final GradoopId newGraphId;

  public CollectEdges(GradoopId newGraphId) {
  ...
  public void reduce(Iterable<Quad> values,
    ...
    while (it.hasNext()) {
      x = it.next();
      //if (!x.f4.equals(GradoopId.NULL_VALUE)) {
        reusable.f0 = x.f5.equals(GradoopId.NULL_VALUE) ? newGraphId : x.f5;
        reusable.f1 = x.f4.equals(GradoopId.NULL_VALUE) ? x.f1 : x.f4;
