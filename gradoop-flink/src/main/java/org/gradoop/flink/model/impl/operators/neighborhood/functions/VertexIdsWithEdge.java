 ...
 */
public class VertexIdsWithEdge implements FlatMapFunction<EPGMEdge, Tuple2<GradoopId, EPGMEdge>> {

  /**
   * Reuse tuple to avoid instantiations.
   */
  private Tuple2<GradoopId, EPGMEdge> reuseTuple;
  ...
  @Override
  public void flatMap(EPGMEdge edge, Collector<Tuple2<GradoopId, EPGMEdge>> collector) throws Exception {
