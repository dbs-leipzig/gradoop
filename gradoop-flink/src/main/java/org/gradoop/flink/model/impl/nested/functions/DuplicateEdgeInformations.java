 ...
 */
public class DuplicateEdgeInformations implements CoGroupFunction<Edge, Quad, Edge> {

  @Override
  public void coGroup(Iterable<Edge> first, Iterable<Quad> second, Collector<Edge> out) throws
    Exception {
