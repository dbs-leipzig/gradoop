 ...
 */
public class DistinctTargetVertexCountByEdgeLabelCalculator {

  /**
   * Calculates the statistic for a distinct target vertex count by edge labels.
  ...
  public static DataSet<WithCount<String>> createStatistic(final LogicalGraph graph) {
    return new DistinctTargetIdsByEdgeLabel()
        .execute(graph);
  }
