...
import org.gradoop.flink.model.impl.operators.matching.single.cypher.operators.filter.functions.FilterAndProjectEmbedding;
...
public class FilterAndProjectEmbeddings implements PhysicalOperator {
  ...
  public DataSet<Embedding> evaluate() {
    return input.flatMap(
      new FilterAndProjectEmbedding(predicates, propertyKeyMapping, columnMapping)
    );
  }
}
