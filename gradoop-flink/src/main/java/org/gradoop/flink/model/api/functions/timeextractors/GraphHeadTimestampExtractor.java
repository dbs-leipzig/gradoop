 ...
 */
public interface GraphHeadTimestampExtractor
  extends TimestampExtractor<GraphHead, TemporalGraphHead> {

  @Override
  default TemporalGraphHead map(GraphHead value) throws Exception {
    TemporalGraphHead temporalVertex = TemporalGraphHead.fromNonTemporalGraphHead(value);
