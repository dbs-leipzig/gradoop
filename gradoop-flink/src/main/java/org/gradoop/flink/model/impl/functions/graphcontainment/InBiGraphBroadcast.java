...
public class InBiGraphBroadcast<GE extends GraphElement>
  extends BiGraphContainmentFilterBroadcast<GE> {

  @Override
  public boolean filter(GE element) throws Exception {
    return element.getGraphIds().contains(graphIdL) || element.getGraphIds().contains(graphIdR);
  }
}
