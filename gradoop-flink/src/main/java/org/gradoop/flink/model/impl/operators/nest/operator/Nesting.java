...
package org.gradoop.flink.model.impl.operators.nest.operator;
...
public class Nesting extends BinaryOp {
   ...
   */
  @Override
  protected NestedIndexing runWithArgAndLake(FlatModel dataLake, NestedIndexing gU,
    ...
    return new NestedIndexing(gh, vertices, edges);
  }
