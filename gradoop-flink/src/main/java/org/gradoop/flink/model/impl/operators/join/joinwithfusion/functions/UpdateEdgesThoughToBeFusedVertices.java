 ...
 */
public class UpdateEdgesThoughToBeFusedVertices implements FlatJoinFunction<Edge, DisambiguationTupleWithVertexId, Edge> {
  /**
   ...
   */
  public UpdateEdgesThoughToBeFusedVertices(boolean isSource) {
    this.isSourceNow = isSource;
  }

  @Override
  public void join(Edge edge, DisambiguationTupleWithVertexId vertex, Collector<Edge> collector) throws Exception {
    if (vertex == null) {
