...
public abstract class SamplingAlgorithm implements UnaryGraphToGraphOperator {
  ...
  /**
   * Key of the PageRankScore property used by {@link PageRankSampling}
   */
  ...
  /**
   * Key of the min_PageRankScore property used by {@link PageRankSampling}
   */
  static final String MIN_PAGE_RANK_SCORE_PROPERTY_KEY = "min_" + PAGE_RANK_SCORE_PROPERTY_KEY;

  /**
   * Key of the max_PageRankScore property used by {@link PageRankSampling}
   */
  static final String MAX_PAGE_RANK_SCORE_PROPERTY_KEY = "max_" + PAGE_RANK_SCORE_PROPERTY_KEY;

  /**
   * Key of the sum_PageRankScore property used by {@link PageRankSampling}
   */
  static final String SUM_PAGE_RANK_SCORE_PROPERTY_KEY = "sum_" + PAGE_RANK_SCORE_PROPERTY_KEY;
