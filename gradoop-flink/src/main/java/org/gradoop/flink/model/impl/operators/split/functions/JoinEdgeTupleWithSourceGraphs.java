...
public class JoinEdgeTupleWithSourceGraphs<E extends Edge>
  implements JoinFunction<E, Tuple2<GradoopId, GradoopIdSet>, Tuple2<E, GradoopIdSet>> {
  ...
  @Override
  public Tuple2<E, GradoopIdSet> join(E left, Tuple2<GradoopId, GradoopIdSet> right) {
    reuseTuple.f0 = left;
