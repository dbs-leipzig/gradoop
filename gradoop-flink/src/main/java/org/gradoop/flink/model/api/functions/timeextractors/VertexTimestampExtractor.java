 ...
 */
public interface VertexTimestampExtractor extends TimestampExtractor<Vertex, TemporalVertex> {

  @Override
  default TemporalVertex map(Vertex value) throws Exception {
    TemporalVertex temporalVertex = TemporalVertex.fromNonTemporalVertex(value);
