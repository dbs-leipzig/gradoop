...
public abstract class Drill implements UnaryGraphToGraphOperator {
   ...
   */
  Drill(String label, String propertyKey, DrillFunction vertexDrillFunction, DrillFunction edgeDrillFunction, DrillFunction graphheadDrillFunction, String newPropertyKey, Element element) {
  ...
  public static class DrillBuilder {
    ...
    public DrillUp buildDrillUp() {
      ...
      return new DrillUp(
        label, propertyKey, vertexDrillFunction, edgeDrillFunction, graphheadDrillFunction, newPropertyKey, element);
    }
