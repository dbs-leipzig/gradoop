...
/**
 * Computes {@link EdgeLabelDistribution} for a given logical graph and write it in a CSV file.
 */
public class EdgeLabelDistributionWriter {

  /**
   * Prepares the statistic for a edge label distribution.
