...
public class FusionUtils {
  ...
  public static <P extends GraphElement> DataSet<P> areElementsInGraph(DataSet<P> head,
    LogicalGraph g, boolean inGraph) {
    return head.filter(inGraph ? new InGraphBroadcast<>() : new NotInGraphBroadcast<>())
