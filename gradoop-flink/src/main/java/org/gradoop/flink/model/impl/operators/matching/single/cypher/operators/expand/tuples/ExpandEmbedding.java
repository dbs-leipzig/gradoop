 ...
 * The end node (f2) is the last element in expanded path (a node).
 * It is stored separately to enable using it as a join column.
 */
public class ExpandEmbedding extends Tuple3<Embedding, GradoopId[], GradoopId> {
   ...
   * {@code (base,(a,b,c),d) x (d,e,f) -> (base, (a,b,c,d,e), f)}
   *
   ...
   * {@code (base,(a,b,c),d) -> (base, IdListEntry(a,b,c), IdEntry(d))}
   *
