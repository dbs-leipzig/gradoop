...
import org.gradoop.flink.model.api.epgm.GraphBase;
 ...
 * @see GraphCollection
 */
public abstract class GVEGraphBase implements GraphBase {
  /**
   ...
   */
  protected GVEGraphBase(DataSet<GraphHead> graphHeads, DataSet<Vertex> vertices,
   ...
   */
  static DataSet<GraphHead> createGraphHeadDataSet(
   ...
   */
  static DataSet<Vertex> createVertexDataSet(
   ...
   * @return edge dataset
   */
  static DataSet<Edge> createEdgeDataSet(Collection<Edge> edges,
