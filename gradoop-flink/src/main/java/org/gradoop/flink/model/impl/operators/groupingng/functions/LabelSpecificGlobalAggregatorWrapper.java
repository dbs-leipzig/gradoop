 ...
 * in any label group.
 */
public class LabelSpecificGlobalAggregatorWrapper extends AggregatorWrapper {
   ...
   */
  public LabelSpecificGlobalAggregatorWrapper(Set<String> otherLabels, AggregateFunction function) {
    super(function);
