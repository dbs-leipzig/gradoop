 ...
 */
public class FromStringToMemeAdjacency extends FromStringToAdjacencyList<String, MemeTrackerEdge, MemeTrackerRecordParser> {
  /**
   * Default constructor
   */
  public FromStringToMemeAdjacency() {
    super(new MemeTrackerRecordParser());
  }
}
