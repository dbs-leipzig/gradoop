...
public class InitEPGMEdge<K extends Comparable<K>>
  extends InitEPGMElement<EPGMEdge, K>
   ...
   */
  public InitEPGMEdge(EPGMEdgeFactory edgeFactory, String lineagePropertyKey,
