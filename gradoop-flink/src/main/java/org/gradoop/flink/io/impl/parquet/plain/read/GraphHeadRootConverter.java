 ...
 */
public class GraphHeadRootConverter extends GradoopRootConverter<EPGMGraphHead> {
   ...
   */
  public GraphHeadRootConverter(MessageType requestedSchema) {
  ...
  @Override
  protected EPGMGraphHead createRecord() {
    return new EPGMGraphHead();
  }
}
