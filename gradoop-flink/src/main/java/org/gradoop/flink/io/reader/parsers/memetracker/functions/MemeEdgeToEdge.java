...
import org.gradoop.flink.io.reader.parsers.functions.GradoopIdToString;
import org.gradoop.flink.io.reader.parsers.functions.ToEdge;
 ...
 */
public class MemeEdgeToEdge extends ToEdge<String, MemeTrackerEdge> {
  /**
   * Default Constructor
   */
  public MemeEdgeToEdge() {
