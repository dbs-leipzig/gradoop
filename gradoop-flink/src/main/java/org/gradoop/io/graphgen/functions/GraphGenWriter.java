...
/**
 * Used to convert GraphTransactions into graphgen documents.
 */
public class GraphGenWriter {
   ...
   */
  public static class GraphTransactionsToGraphGenFile<G extends
    ...
    /**
     * Creates a GraphGen string representation of a given graph transaction.
     *
     * @param graphTransaction graph transaction
     * @return GraphGen string representation
     */
    @Override
