...
public abstract class GradoopTestBaseUtils {
  ...
  public static Collection<VertexPojo> createVertexPojoCollection() {
    ...
    VERTEX_PERSON_ALICE = vertexDataFactory
      .createVertex(0L, LABEL_PERSON, properties, Sets.newHashSet(0L, 2L));
    // Person:Bob (1L)
    ...
    VERTEX_PERSON_BOB = vertexDataFactory
      .createVertex(1L, LABEL_PERSON, properties, Sets.newHashSet(0L, 2L));
    // Person:Carol (2L)
    properties = new HashMap<>();
    ...
    VERTEX_PERSON_CAROL = vertexDataFactory
      .createVertex(2L, LABEL_PERSON, properties, Sets.newHashSet(1L, 2L, 3L));
    // Person:Dave (3L)
    properties = new HashMap<>();
    ...
    VERTEX_PERSON_DAVE = vertexDataFactory
      .createVertex(3L, LABEL_PERSON, properties, Sets.newHashSet(1L, 2L, 3L));
    // Person:Eve (4L)
    properties = new HashMap<>();
    ...
    VERTEX_PERSON_EVE = vertexDataFactory
      .createVertex(4L, LABEL_PERSON, properties, Sets.newHashSet(0L));
    // Person:Frank (5L)
    properties = new HashMap<>();
    ...
    VERTEX_PERSON_FRANK = vertexDataFactory
      .createVertex(5L, LABEL_PERSON, properties, Sets.newHashSet(1L));

    // Tag:Databases (6L)
    properties = new HashMap<>();
    properties.put(PROPERTY_KEY_NAME, "Databases");
    VERTEX_TAG_DATABASES =
      vertexDataFactory.createVertex(6L, LABEL_TAG, properties);
    // Tag:Databases (7L)
    properties = new HashMap<>();
    properties.put(PROPERTY_KEY_NAME, "Graphs");
    VERTEX_TAG_GRAPHS =
      vertexDataFactory.createVertex(7L, LABEL_TAG, properties);
    // Tag:Databases (8L)
    properties = new HashMap<>();
    properties.put(PROPERTY_KEY_NAME, "Hadoop");
    VERTEX_TAG_HADOOP =
      vertexDataFactory.createVertex(8L, LABEL_TAG, properties);

    // Forum:Graph Databases (9L)
    properties = new HashMap<>();
    properties.put(PROPERTY_KEY_TITLE, "Graph Databases");
    VERTEX_FORUM_GDBS =
      vertexDataFactory.createVertex(9L, LABEL_FORUM, properties);
    // Forum:Graph Processing (10L)
    properties = new HashMap<>();
    properties.put(PROPERTY_KEY_TITLE, "Graph Processing");
    VERTEX_FORUM_GPS = vertexDataFactory
      .createVertex(10L, LABEL_FORUM, properties, Sets.newHashSet(3L));
  ...
  public static Collection<EdgePojo> createEdgePojoCollection() {
    ...
    EDGE_0_KNOWS = edgeDataFactory
      .createEdge(0L, LABEL_KNOWS, VERTEX_PERSON_ALICE.getId(),
        VERTEX_PERSON_BOB
    ...
    EDGE_1_KNOWS = edgeDataFactory
      .createEdge(1L, LABEL_KNOWS, VERTEX_PERSON_BOB.getId(),
    ...
    EDGE_2_KNOWS = edgeDataFactory
      .createEdge(2L, LABEL_KNOWS, VERTEX_PERSON_BOB.getId(),
    ...
    EDGE_3_KNOWS = edgeDataFactory
      .createEdge(3L, LABEL_KNOWS, VERTEX_PERSON_CAROL.getId(),
    ...
    EDGE_4_KNOWS = edgeDataFactory
      .createEdge(4L, LABEL_KNOWS, VERTEX_PERSON_CAROL.getId(),
    ...
    EDGE_5_KNOWS = edgeDataFactory
      .createEdge(5L, LABEL_KNOWS, VERTEX_PERSON_DAVE.getId(),
    ...
    EDGE_6_KNOWS = edgeDataFactory
      .createEdge(6L, LABEL_KNOWS, VERTEX_PERSON_EVE.getId(),
    ...
    EDGE_21_KNOWS = edgeDataFactory
      .createEdge(21L, LABEL_KNOWS, VERTEX_PERSON_EVE.getId(),
    ...
    EDGE_22_KNOWS = edgeDataFactory
      .createEdge(22L, LABEL_KNOWS, VERTEX_PERSON_FRANK.getId(),
    ...
    EDGE_23_KNOWS = edgeDataFactory
      .createEdge(23L, LABEL_KNOWS, VERTEX_PERSON_FRANK.getId(),
    ...
    EDGE_7_HAS_INTEREST = edgeDataFactory
      .createEdge(7L, LABEL_HAS_INTEREST, VERTEX_PERSON_EVE.getId(),
    ...
    EDGE_8_HAS_INTEREST = edgeDataFactory
      .createEdge(8L, LABEL_HAS_INTEREST, VERTEX_PERSON_ALICE.getId(),
        VERTEX_TAG_DATABASES.getId());
    edges.add(EDGE_8_HAS_INTEREST);
    // Person:Dave-[hasInterest]->Tag:Hadoop (9L)
    EDGE_9_HAS_INTEREST = edgeDataFactory
      .createEdge(9L, LABEL_HAS_INTEREST, VERTEX_PERSON_DAVE.getId(),
    ...
    EDGE_16_HAS_MODERATOR = edgeDataFactory
      .createEdge(16L, LABEL_HAS_MODERATOR, VERTEX_FORUM_GPS.getId(),
    ...
    EDGE_17_HAS_MEMBER = edgeDataFactory
      .createEdge(17L, LABEL_HAS_MEMBER, VERTEX_FORUM_GDBS.getId(),
        VERTEX_PERSON_ALICE.getId());
    edges.add(EDGE_17_HAS_MEMBER);
    // Forum:Graph Databases-[hasMember]->Person:Bob (18L)
    EDGE_18_HAS_MEMBER = edgeDataFactory
      .createEdge(18L, LABEL_HAS_MEMBER, VERTEX_FORUM_GDBS.getId(),
    ...
    EDGE_19_HAS_MEMBER = edgeDataFactory
      .createEdge(19L, LABEL_HAS_MEMBER, VERTEX_FORUM_GPS.getId(),
    ...
    EDGE_20_HAS_MEMBER = edgeDataFactory
      .createEdge(20L, LABEL_HAS_MEMBER, VERTEX_FORUM_GPS.getId(),
  ...
  public static Collection<GraphHeadPojo> createGraphHeadCollection() {
    ...
    communityDatabases =
      graphDataFactory.createGraphHead(0L, LABEL_COMMUNITY, properties);
    ...
    properties.put(PROPERTY_KEY_VERTEX_COUNT, 3);
    communityHadoop =
      graphDataFactory.createGraphHead(1L, LABEL_COMMUNITY, properties);
    ...
    communityGraphs =
      graphDataFactory.createGraphHead(2L, LABEL_COMMUNITY, properties);
    graphs.add(communityGraphs);
    // Forum {} (3L)
    forumGraph = graphDataFactory.createGraphHead(3L, LABEL_FORUM);
