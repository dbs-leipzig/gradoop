 ...
 */
public class DefaultPersistentGraphData extends
  PersistentEPGMElement<GraphData> implements PersistentGraphData {
   ...
   * Default constructor.
   */
  public DefaultPersistentGraphData() {
  }
   ...
   */
  public DefaultPersistentGraphData(GraphData graphData, Set<Long> vertices,
    Set<Long> edges) {
    super(graphData);
