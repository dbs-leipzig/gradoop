 ...
 */
public class BulkLoadEPG extends Mapper<LongWritable, Text,
  ImmutableBytesWritable, Put> {

  /**
   * Configuration key for the vertex line reader.
   */
  public static final String VERTEX_LINE_READER = BulkLoadEPG.class.getName()
    + ".vertex_line_reader";
  /**
   * Configuration key for the vertex handler.
   */
  public static final String VERTEX_HANDLER = BulkLoadEPG.class.getName()
    + ".vertex_handler";
  /**
  ...
  protected void setup(Context context)
    ...
    Class<? extends VertexLineReader> readerClass = conf.getClass(
      VERTEX_LINE_READER,
      null,
