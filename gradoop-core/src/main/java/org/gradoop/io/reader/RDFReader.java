...
//    String p = triple[1];
//    String o = triple[2];
//    List<VertexData> vList = Lists.newArrayListWithCapacity(2);
//
//    if (o.startsWith("\"")) { // create one vertex with property
//      VertexData vertexData = createVertexWithLiteral(s, p, o);
//      vList.add(vertexData);
//    } else { // 2x resource -> 2x vertex
//      VertexData sourceVertexData = createSourceVertex(s, p, o);
//      VertexData targetVertexData = createTargetVertex(s, p, o);
//      vList.add(sourceVertexData);
//      vList.add(targetVertexData);
//    }
//    return vList;
//  }
//
...
//   */
//  private VertexData createTargetVertex(String s, String p, String o) {
...
//      Lists.newArrayList(edgeDataIn), null);
//  }
//
//  /**
...
//   * @return resulting vertex
//   */
//  private VertexData createSourceVertex(String s, String p, String o) {
//    Long sourceID = getHash(s);
//    Long targetID = getHash(o);
//    Long edgeOutIndex = getHash(s + p + o);
//    EdgeData edgeDataOut =
...
//      Lists.newArrayList(edgeDataOut));
//  }
//
//  /**
...
//   * @return resulting vertex
//   */
//  private VertexData createVertexWithLiteral(String s, String p, String o) {
//    Long sourceID = getHash(s);
