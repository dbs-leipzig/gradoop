...
/**
 * Generates Gradoop IDs using the current time in milliseconds as sequence
 * number.
 *
 * Note that this generator does not guarantee unique identifiers as the time
 * depends solely on the system on which the generator is executed.
 */
