...
import org.gradoop.algorithms.fsm.gspan.encoders.functions.EdgeLabels;
import org.gradoop.algorithms.fsm.gspan.encoders.functions.EdgeLabelsEncoderInteger;
...
import org.gradoop.algorithms.fsm.gspan.encoders.functions.TLFVertexLabels;
import org.gradoop.algorithms.fsm.gspan.encoders.functions.TLFVertexLabelsEncoder;
import org.gradoop.algorithms.fsm.gspan.encoders.tuples.EdgeTripleWithStringEdgeLabel;
 ...
 */
public class GSpanTLFGraphEncoder implements GSpanEncoder<DataSet<TLFGraph>> {
  /**
   * minimum support
   */
