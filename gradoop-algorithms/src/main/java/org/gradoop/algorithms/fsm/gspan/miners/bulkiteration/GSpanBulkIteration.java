...
package org.gradoop.algorithms.fsm.gspan.miners.bulkiteration;
...
import org.gradoop.algorithms.fsm.gspan.miners.bulkiteration.functions
  .HasGrownSubgraphs;
import org.gradoop.algorithms.fsm.gspan.miners.bulkiteration.functions.IsCollector;
import org.gradoop.algorithms.fsm.gspan.miners.bulkiteration.functions
  .IterationItemWithCollector;
import org.gradoop.algorithms.fsm.gspan.miners.bulkiteration.pojos.IterationItem;

import org.gradoop.algorithms.fsm.gspan.miners.GSpanBase;
import org.gradoop.algorithms.fsm.config.BroadcastNames;
import org.gradoop.algorithms.fsm.gspan.miners.bulkiteration.functions.GrowFrequentSubgraphs;

import org.gradoop.algorithms.fsm.gspan.miners.bulkiteration.functions.IsTransaction;
import org.gradoop.algorithms.fsm.gspan.miners.bulkiteration.functions.IterationItemWithTransaction;
import org.gradoop.algorithms.fsm.gspan.miners.bulkiteration.functions.SubgraphCollection;
import org.gradoop.algorithms.fsm.gspan.miners.bulkiteration.functions.ExpandSubgraphs;
import org.gradoop.algorithms.fsm.gspan.functions.Frequent;
import org.gradoop.algorithms.fsm.gspan.miners.bulkiteration.functions.PostPruneAndCompress;
import org.gradoop.algorithms.fsm.gspan.miners.bulkiteration.functions.ReportGrownSubgraphs;
import org.gradoop.algorithms.fsm.gspan.pojos.CompressedDFSCode;
import org.gradoop.algorithms.fsm.gspan.pojos.GSpanGraph;
import org.gradoop.algorithms.fsm.gspan.pojos.SerializedDFSCode;
