...
public class GradoopFormatConverter extends AbstractRunner implements ProgramDescription {
   ...
   *
   * args[0] - path to input graph (or table prefix for store formats, e.g. "mytable.")
   * args[1] - format of input graph (lgcsv, lgindexed, csv, json, indexed, hbase, accumulo)
   * args[2] - path to output graph (or table prefix for store formats, e.g. "mytable.")
   * args[3] - format of output graph (csv, json, indexed, hbase, accumulo)
   *
