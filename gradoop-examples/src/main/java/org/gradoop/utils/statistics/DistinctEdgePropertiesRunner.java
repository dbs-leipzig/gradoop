 ...
 */
public class DistinctEdgePropertiesRunner extends AbstractRunner implements ProgramDescription {
  ...
  public static void main(String[] args) throws Exception {
    ...
    DistinctEdgePropertiesCalculator.writeCSV(
  ...
  public String getDescription() {
    return DistinctEdgePropertiesRunner.class.getName();
  }
}
