 ...
 */
public class DistinctSourceVertexCountByEdgeLabelRunner extends AbstractRunner implements ProgramDescription {
  ...
  public static void main(String[] args) throws Exception {
    ...
    DistinctSourceVertexCountByEdgeLabelCalculator.writeCSV(
  ...
  public String getDescription() {
    return DistinctSourceVertexCountByEdgeLabelRunner.class.getName();
  }
}
