 ...
 */
public class DistinctEdgePropertiesByLabelRunner extends AbstractRunner implements ProgramDescription {
  ...
  public static void main(String[] args) throws Exception {
    ...
    DistinctEdgePropertiesByLabelCalculator.writeCSV(
  ...
  public String getDescription() {
    return DistinctEdgePropertiesByLabelRunner.class.getName();
  }
}
