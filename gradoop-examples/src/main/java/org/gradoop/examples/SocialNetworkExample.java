 ...
 */
public class SocialNetworkExample implements ProgramDescription {
  ...
  public String getDescription() {
    return SocialNetworkExample.class.getName();
  }
}
