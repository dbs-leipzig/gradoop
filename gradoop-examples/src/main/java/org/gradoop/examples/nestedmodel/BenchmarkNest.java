 ...
 */
public class BenchmarkNest extends AbstractRunner implements ProgramDescription {
  ...
  public static void main(String[] args) throws Exception {
    ...
    DataSource dataSource = new EdgeListDataSource(inputPath, "\t",
  ...
  public String getDescription() {
    return BenchmarkNest.class.getName();
  }
}
