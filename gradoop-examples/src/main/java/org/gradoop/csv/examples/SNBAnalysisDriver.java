...
import org.gradoop.io.formats.EPGHBaseVertexOutputFormat;
 ...
 */
public class SNBAnalysisDriver extends BulkDriver {

  private static Logger LOG = Logger.getLogger(SNBAnalysisDriver.class);
  ...
  public static void main(String[] args) throws Exception {
    ...
    System.exit(ToolRunner.run(conf, new SNBAnalysisDriver(), args));
  }
}
