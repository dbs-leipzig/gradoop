...
public class AggregationExample {
  ...
  public static void main(String[] args) throws Exception {
    ...
    // printing the graph only works when this program is executed in a local environment
    // uncomment the following line to print the whole graph
    //result.print();

    // for distributed execution we just print the graph head dataset, which contains the aggregate results
