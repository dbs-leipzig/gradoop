...
import static org.gradoop.dataintegration.importer.rdbmsimporter.constants.RdbmsConstants.RdbmsType.MYSQL_TYPE;
...
public class Helper {
   ...
   */
  public static Properties parseRowToProperties(Row tuple, RowHeader rowheader) {
   ...
   * @return EPGM properties
   */
  public static Properties parseRowToPropertiesWithoutForeignKeys(Row tuple, RowHeader rowheader) {
