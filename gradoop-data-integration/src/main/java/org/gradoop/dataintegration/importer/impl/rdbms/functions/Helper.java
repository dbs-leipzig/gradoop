...
import org.gradoop.dataintegration.importer.impl.rdbms.connection.GradoopJDBCDriver;
...
public class Helper {
   ...
   */
  public static RdbmsConstants.RdbmsType chooseRdbmsType(String rdbmsName)
   ...
   */
  static DataSet<Row> getRdbmsInput(
   ...
   * @return EPGM properties
   */
  static Properties parseRowToPropertiesWithoutForeignKeys(
